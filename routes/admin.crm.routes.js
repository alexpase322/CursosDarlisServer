...
const { recalculateAllAchievements, recalculateAllRanksEndpoint, getRanksOverview } = require('../controllers/engagement.controller');
...
router.get('/ranks', getRanksOverview);
