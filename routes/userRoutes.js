...
const { updateUserProfile, getAllUsers, updateUserRole, deleteUser, getPublicProfile } = require('../controllers/userController');
...
// Perfil público de una alumna (solo para miembros de la comunidad)
